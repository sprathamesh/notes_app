...
abstract class UpdateNote implements HomeEvent {
  const factory UpdateNote({required final NotesModel note}) = _$UpdateNoteImpl;
...
abstract class AddNote implements HomeEvent {
  const factory AddNote({required final NotesModel note}) = _$AddNoteImpl;
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      ...
      required final List<NotesModel> notesModelList}) = _$HomeStateImpl;
